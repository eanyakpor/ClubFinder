...
export default function StudentSignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Student Registered:", { username, email, password });
  };
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-3 rounded-xl font-semibold bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-400 hover:to-blue-400 transition-all duration-300 shadow-lg"
        >
          Register
        </button>
        ...
        <p className="text-center text-sm mt-3 text-gray-200">
          ...
          <Link href="/" className="underline text-purple-300 hover:text-purple-200">
            Back to Home
          </Link>
        </p>
      </form>
